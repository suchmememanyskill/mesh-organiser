...
INSERT INTO users (user_name, user_email, user_password_hash, user_created_at, user_permissions) VALUES ('local', 'local@local', 'hashed_password_here', strftime('%Y-%m-%dT%H:%M:%SZ', datetime('now')), 2147483647);
