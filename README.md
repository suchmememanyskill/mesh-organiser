...
Download for:
- [Windows](https://github.com/suchmememanyskill/mesh-organiser/releases/download/v2.0.1/Mesh.Organiser_2.0.1_x64_en-US.msi) (.msi)
- Macos
    - [aarch64/Arm based chips (M-line)](https://github.com/suchmememanyskill/mesh-organiser/releases/download/v2.0.1/Mesh.Organiser_2.0.1.dmg)
    - [x64/Intel based chips](https://github.com/suchmememanyskill/mesh-organiser/releases/download/v2.0.1/Mesh.Organiser_2.0.1_x64.dmg)
- Linux
    - [Debian/Ubuntu](https://github.com/suchmememanyskill/mesh-organiser/releases/download/v2.0.1/Mesh.Organiser_2.0.1_amd64.deb) (.deb)
